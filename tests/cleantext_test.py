...
from ternaus_cleantext.ternaus_cleantext import basic_clean, clean_text, html_clean, url_clean, whitespace_clean


@mark.parametrize(
    ["input_text", "output_text"],
    [("https://ternaus.com", "https://ternaus.com"), ("this is a test <b>bold</b>", "this is a test bold")],
)
...
@mark.parametrize(
    ["input_text", "output_text"], [("test &#38;", "test &"), ("https://ternaus.com", "https://ternaus.com")]
)
...
@mark.parametrize(
    ["input_text", "output_text"],
    [("test   https://ternaus.com Test", "test    Test"), ("test   http://ternaus.com Test", "test    Test")],
)
